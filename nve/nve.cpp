...
void NVE::init_input(string input)
{
	ifstream input_file;
...
void NVE::init_config(string config, double r[][3])
{
...
NVE::NVE(string input, string config, string old)
{
...
void NVE::move(void){ //Move particles with Verlet algorithm
	double r_new[3];
...
double NVE::force(int ip, int idir) const
{
	double f=0.0;
...
void NVE::conf_final(string config, string old) const
...
void NVE::conf_xyz(int nconf) const
