...
NVT::NVT(string input_file, string config_file):
...
void NVT::ConfXYZ(int nconf){ //Write configuration in .xyz format
  ofstream WriteXYZ;
...
double NVT::Pbc(double r)  //Algorithm for periodic boundary conditions with side L=box
{
